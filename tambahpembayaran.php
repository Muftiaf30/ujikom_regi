<?php include('config.php'); ?>
		...
		if(isset($_POST['submit'])){
			...
			if(mysqli_num_rows($cek) == 0){
				...
				if($sql){
					echo '<script>alert("Berhasil menambahkan data."); document.location="beranda.php?page=tambah_pembayaran";</script>';
				}else{
		...
		<form action="beranda.php?page=tambah_pembayaran" method="post">
